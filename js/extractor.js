...
const Extractor = (() => {
  ...
  const SUBJECT_MAP = [
    ...
    {
      group: '예술',
      keywords: ['음악', '미술', '연주', '합창', '오케스트라', '조소', '디자인',
                 '서양음악', '국악', '회화', '공예', '사진'],
    },
    {
      group: '체육',
      keywords: ['체육', '스포츠', '운동', '건강', '체력'],
    },
    {
      group: '기술·정보',
      keywords: ['기술', '가정', '정보', '컴퓨터', '인공지능', 'AI', '코딩',
                 '프로그래밍', '로봇', '소프트웨어', '데이터'],
    },
    {
      group: '제2외국어·한문',
      keywords: ['제2외국어', '일본어', '중국어', '스페인어', '프랑스어',
                 '독일어', '러시아어', '베트남어', '아랍어', '한문'],
    },
    {
      group: '진로·기타',
      keywords: ['진로', '직업', '창업', '철학', '심리', '교육', '보건'],
    },
  ];
