...
3. ${hasObservation ? '아래 [교사 관찰 메모]를 1순위 근거로 삼고, [수행평가·자기평가서 원문]은 보조 근거로만 활용할 것.' : '[교사 관찰 메모]가 제공되지 않았으므로, 학생의 역량·태도·성장을 단정하지 말고 원문에서 확인되는 사실 중심으로 보수적으로 작성할 것.'}
...
수행평가·자기평가서 원문은 이 관찰 내용을 뒷받침하는 보조 자료로만 사용하십시오.
...
아래 [수행평가·자기평가서 원문]만을 근거로, 학생의 역량이나 태도를 단정하지 말고 원문에서 확인되는 활동 사실 중심으로 보수적으로 작성하십시오.
